...
@app.route('/mike_guest')
@requires_access_level(ACCESS['guest'])
def mike_guest():
    return render_template('mike_guest.html', pageTitle='mike_guest access')

@app.route('/mike_user')
@requires_access_level(ACCESS['user'])
def mike_user():
    return render_template('mike_user.html', pageTitle='mike_user access')

@app.route('/mike_admin')
@requires_access_level(ACCESS['admin'])
def mike_admin():
    return render_template('mike_admin.html', pageTitle='mike_admin access')
